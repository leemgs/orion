...
The dependency-light CPU probe allocates a NumPy array, constructs a seeded
random permutation, and traverses it as a dependent pointer chain. Dependence
between successive indices limits vectorisation and hardware prefetching. We
...
deviation, and trial count. The nominal fast-tier capacity was 33~MiB, matching
the reported last-level cache of the test environment. No outlier was removed.
...
Both probes were run with Python 3.11 and NumPy. Seeds, grids, timing code, raw
records, summaries, and commands are version controlled. The analytical regime
