...
\begin{itemize}
  ...
  \item \textbf{Minimal analytical model.}
    ...
    as the majority-residency crossover; both computable from a 10-minute
    profiling session without exhaustive sweeps.
...
small ($D \approx 1.2$\,GB per step); at $T_{\mathrm{comp}} \approx 120$\,ms,
