...
\begin{itemize}
  ...
  \item \textbf{Open proof of concept.}
    Two independently implemented CPU probes test the capacity prediction, and
    the released harness provides CUDA and XLA paths for a future accelerator
    campaign. We distinguish those unexecuted paths from reported evidence.
\end{itemize}

Together, the formulation and proof-of-concept data provide a reproducible
