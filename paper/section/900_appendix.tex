...
Runs reported in the main-text accelerator Results were performed on three
accelerators of two vendors: an NVIDIA \GpuDevice{} and an NVIDIA A100 through the
...
reaches both sides of the overlap coordinate; these are proof-of-concept checks,
not a preregistered multi-platform
