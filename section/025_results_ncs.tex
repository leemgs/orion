...
the classifier contributes 66--76\% of total gain---gains not observed
under any fixed-strategy configuration in our experiments---confirming
that adaptive regime classification is the primary mechanism enabling
performance gains beyond hardware tuning
