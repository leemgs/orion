...
\caption{Latency change relative to PyTorch default across all three regimes
         ...
         \emph{Italic negative}: worse than baseline.}
...
\begin{table}[t]
\centering
\caption{Regime structure and latency improvement for non-LLM workloads.
         ...
         Latency improvement: regime-aware \textsc{Orion} vs.\ PyTorch default.}
\label{tab:generality}
\renewcommand{\arraystretch}{1.2}
\footnotesize
\begin{tabular}{llcccc}
\toprule
\textbf{Workload} & \textbf{Framework} &
  \makecell{\textbf{Observed}\\\textbf{regime}} &
  $R_C$ & $R_B$ &
  \makecell{\textbf{Latency}\\\textbf{reduction}} \\
\midrule
BLIP2 VQA  & HuggingFace & Coord.-dom.\ $\to$ I/O-lim.\
             & $0.53\!\to\!0.51$ & $0.43\!\to\!0.31$ & $11.2 \pm 1.4\%$ \\
RAG (FAISS)& LangChain   & Cap.-lim.\ $\to$ Coord.-dom.\
             & $0.46\!\to\!0.58$ & $0.42$ & $17.4 \pm 1.8\%$ \\
YOLOv8     & Ultralytics & I/O-limited
             & $0.49$ & $0.22$ & $9.5 \pm 1.2\%$ \\
\bottomrule
\end{tabular}
\end{table}
